...
The final dataset merges information about bakers, episodes, and their performance. It organizes bakers' demographic data (age, occupation, hometown) along with their performance data from different baking challenges. The dataset still have some misssing values in different columns.
...
```
The average viewership in Season 1 is `r avg_season1`.

The average viewership in Season 5 is `r avg_season5`.
